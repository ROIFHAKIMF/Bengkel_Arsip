<div class="service-1">
    <a class="btn-exit" href="#service" onclick="hideServiceDetail(); return false;"><i class="bi bi-x fw"></i></a>
    ...
    <div class="desc">
        ...
        <div class="d-flex flex-row w-50 justify-center align-items-center gap-2">
            <a class="btn-services w-50" href="#service" onclick="showServiceDetail(1); return false;"><i class="bi bi-arrow-left-short fs-bold"></i>Previous</a>
            <a class="btn-services w-50" href="#service" onclick="showServiceDetail(3); return false;">Next <i class="bi bi-arrow-right-short fs-bold"></i></a>
        </div>
    </div>
</div>