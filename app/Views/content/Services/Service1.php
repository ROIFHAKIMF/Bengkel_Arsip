<section id="service">
    ...
    <div class="service-1">
        ...
        <div class="img-group row">
            <img src="<?= base_url('img/slide3.jpg') ?>" alt="Digitalisasi Arsip" class="img-fluid col-12">
        ...
        <div class="desc">
            ...
            <div class="d-flex flex-row w-50 justify-center align-items-center gap-2">
                <a class="btn-services w-50" href="<?= base_url(relativePath: "#service") ?>" >Kembali</a>
                <?php if (session()->get('isLoggedIn')): ?>
                    <a class="btn-services w-50" href="<?= base_url('admin?service=2#service') ?>">Next &raquo;</a>
                <?php else:?>
                    <a class="btn-services w-50" href="<?= base_url('/?service=2#service') ?>">Next &raquo;</a>
                <?php endif;?>
            </div>
        </div>
    </div>
